...
def main() -> None:
    ...
    receipt = {
        ...
        "HOST_VERIFICATION_SCOPE": os.environ["HOST_VERIFICATION_SCOPE"],
        "HOST_VERIFICATION_RUN": os.environ["HOST_VERIFICATION_RUN"],
        "HOST_VERIFICATION_COMMIT": os.environ["HOST_VERIFICATION_COMMIT"],
        "HOST_VERIFICATION_CHECKS": os.environ["HOST_VERIFICATION_CHECKS"],
