...
| 顶栏 | `TopAppBar`, `IconButton` | `HyperXPage` | `ToolBoxTopBar` |
| 底部导航 | `NavigationBar` | — | `MainDestinationBar` |
...
| 运行外壳 | `TopAppBar`, `Snackbar`, `FloatingToolbar` | `FullScreenDialog` | `MiniAppWebView`, `SecurityStatusStrip` |
