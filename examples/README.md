...
- NextFlux 1.0.5 与 ToolBox 0.6.7 配套，通过 GitHub CI 交付；保留完整文章和同步范围，增加系统浏览器打开、长文分批显示、按可见块加载字体与高亮，并优化增量写入和同步交互调度。旧 [1.0.3](packages/nextflux-v1.0.3.tbx) 与 [1.0.1](packages/nextflux-v1.0.1.tbx) 保留。四个内置示例沿用已通过 CI 的 ToolBox 0.6.4 包。
